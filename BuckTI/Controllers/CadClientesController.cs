...
namespace BuckTI.Controllers
{
    public class CadClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCliente,NomeCliente,SobrenomeCliente,CPFCliente,TelefoneCliente")] CadClientes cadClientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,NomeCliente,SobrenomeCliente,CPFCliente,TelefoneCliente")] CadClientes cadClientes)
        {
